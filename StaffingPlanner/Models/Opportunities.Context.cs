...
namespace StaffingPlanner.Models
{
    ...
    public partial class DEV_ClientOpportunitiesEntities : DbContext
    {
        ...
        public virtual DbSet<OPPORTUNITY_CATALOG> OPPORTUNITY_CATALOG { get; set; }
        public virtual DbSet<OPPORTUNITY_GROUP> OPPORTUNITY_GROUP { get; set; }
        ...
        public virtual int practiceManager_viewProjectsWithOpportunityStatus()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("practiceManager_viewProjectsWithOpportunityStatus");
        }
    
        public virtual int salesPersons_viewProjectsWithOpportunityStatus()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("salesPersons_viewProjectsWithOpportunityStatus");
        }
        ...
        public virtual int createDevBackup1()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("createDevBackup1");
        }
        ...
        public virtual ObjectResult<STATS_LOST_OPPORTUNITY1_Result> STATS_LOST_OPPORTUNITY1()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<STATS_LOST_OPPORTUNITY1_Result>("STATS_LOST_OPPORTUNITY1");
        }
    
        public virtual ObjectResult<STATS_OPPORTUNITY_STATUS1_Result> STATS_OPPORTUNITY_STATUS1()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<STATS_OPPORTUNITY_STATUS1_Result>("STATS_OPPORTUNITY_STATUS1");
        }
    
        public virtual ObjectResult<STATS_PORTFOLIO1_Result> STATS_PORTFOLIO1()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<STATS_PORTFOLIO1_Result>("STATS_PORTFOLIO1");
        }
    
        public virtual ObjectResult<STATS_PROJECTED_PROFIT1_Result> STATS_PROJECTED_PROFIT1()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<STATS_PROJECTED_PROFIT1_Result>("STATS_PROJECTED_PROFIT1");
        }
    }
}
